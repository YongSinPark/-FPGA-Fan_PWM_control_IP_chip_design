...
set_property -dict { PACKAGE_PIN V16  IOSTANDARD LVCMOS33 } [get_ports { i_enable  }]; #IO_L19P_T3_A10_D26_14      ,Sch=SW1
...
set_property -dict { PACKAGE_PIN U16  IOSTANDARD LVCMOS33 } [get_ports { o_mode_led[0]  }]; #IO_L23N_T3_A02_D18_14        ,Sch=LED0
set_property -dict { PACKAGE_PIN E19  IOSTANDARD LVCMOS33 } [get_ports { o_mode_led[1]  }]; #IO_L3N_T0_DQS_EMCCLK_14      ,Sch=LED1
set_property -dict { PACKAGE_PIN U19  IOSTANDARD LVCMOS33 } [get_ports { o_mode_led[2]  }]; #IO_L15P_T2_DQS_RDWR_B_14     ,Sch=LED2
...
set_property -dict { PACKAGE_PIN J1  IOSTANDARD LVCMOS33 } [get_ports { o_mode }]; #IO_L3N_T0_DQS_AD5N_35 ,Sch=JA1
